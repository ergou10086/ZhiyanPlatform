 ...
 * @author ErgouTree
 */
@FeignClient(name = "zhiyan-knowledge")
public interface KnowledgeServiceClient {
    ...
    R<FileContext> getFileById(@PathVariable("fileId") Long fileId);
    ...
    R<List<FileContext>> getFilesByIds(@RequestParam("fileIds") List<Long> fileIds);
