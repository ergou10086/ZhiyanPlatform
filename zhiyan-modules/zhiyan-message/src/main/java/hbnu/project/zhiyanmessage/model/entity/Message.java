package hbnu.project.zhiyanmessage.model.entity;
...
public class Message extends BaseAuditEntity {
    ...
    @Builder.Default
    private List<MessageReception> recipients = new ArrayList<>();
     ...
     * 便捷方法：添加收件人
     */
    public void addRecipient(MessageReception recipient) {
     ...
     * 便捷方法：批量添加收件人
     */
    public void addRecipients(List<MessageReception> recipientList) {
