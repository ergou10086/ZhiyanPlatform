package hbnu.project.zhiyansentineldashboard.filter;
...
public class SecurityConfig {
    ...
    @Value("${spring.cloud.nacos.discovery.metadata.username:sentinel}")
    private String username;
    @Value("${spring.cloud.nacos.discovery.metadata.userpassword:sentinel}")
