package hbnu.project.zhiyancommonexcel.utils;
...
import hbnu.project.zhiyancommonexcel.convert.ExcelBigNumberConvert;
import hbnu.project.zhiyancommonexcel.core.*;
import hbnu.project.zhiyancommonexcel.handler.DataWriteHandler;
...
public class ExcelUtil {
    ...
    public static String convertByExp(String propertyValue, String converterExp, String separator) {
        ...
        String[] convertSource = converterExp.split(StringUtils.COMMA);
